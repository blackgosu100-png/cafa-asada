...
12. 5개 제목은 서로 다른 문장 구조와 끝맺음을 가져야 한다. "바꾼 것", "바꾼 이유", "바꿨습니다" 같은 바꾸다 계열 표현은 전체 후보 중 최대 1개만 쓴다.
13. "추천합니다", "필수템", "전격공개", "최저가", "구매하세요" 같은 광고 단어보다 "왜 밀렸는지", "어디서 막혔는지", "손목이 먼저 보이는지", "몇 통부터 힘든지" 같은 상황 단어를 우선한다.`;
}
